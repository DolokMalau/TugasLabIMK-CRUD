            ...
            <br/>
                <form class="form-horizontal" method="post" action="input_aksi.php">
                        <div class="form-group">
                            ...
                            <input class="form-control col-sm-4" type="text" name="id_catatan" placeholder="Silahkan masukkan ID catatan anda di sini" id="id_catatan" onkeypress='return event.charCode >= 48 && event.charCode <= 57' pattern="[0-9]{6}" maxlength="6" size="6" title="Silahkan isi 6 digit angka, angka yang diizinkan mulai dari 0 hingga 9" required>
